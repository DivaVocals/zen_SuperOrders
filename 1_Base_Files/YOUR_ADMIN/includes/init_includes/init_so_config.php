...
$result = (SUPER_ORDERS_MYSQL ? $mysqli->query("SHOW TABLES LIKE '".DB_PREFIX."so_payment_types'") : mysql_query("SHOW TABLES LIKE '".DB_PREFIX."so_payment_types'"));

if (( SUPER_ORDERS_MYSQL ? $result->num_rows : mysql_num_rows($result) )) {
